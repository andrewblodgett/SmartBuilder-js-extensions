/**
 * Checks if an input string matches a specified regular expression pattern.
 * * @param {string} inputString - The string to test against the pattern.
 * @param {string} patternString - The regular expression pattern (e.g., "^[A-Z]+$").
 * @param {string} [flags] - Optional regex flags (e.g., "g", "i").
 * @returns {boolean} True if the pattern matches the input string, false otherwise.
 */
...
/**
 * Extracts all substrings from an input string that match a regular expression pattern.
 * * @param {string} inputString - The string to search.
 * @param {string} patternString - The regular expression pattern.
 * @param {string} [flags] - Optional regex flags (e.g., "g" for global, "i" for case-insensitive).
 * @returns {Array<string>} An array of matched strings, or an empty array if no matches are found.
 */
...
/**
 * Calculates the Levenshtein distance between two strings, representing the minimum 
 * number of single-character edits required to change one word into the other.
 * * @param {string} str1 - The first string to compare.
 * @param {string} str2 - The second string to compare.
 * @returns {number} The raw Levenshtein distance cost.
 */
...
/**
 * Converts the Levenshtein distance between two strings into an easy-to-use similarity percentage.
 * * @param {string} s - The first string.
 * @param {string} t - The second string.
 * @returns {number} A percentage (0 to 100) representing how similar the two strings are.
 */
 ...
 * Highly effective for matching strings where words might be transposed or slightly misspelled.
 * * @param {string} str1 - The first string to compare.
 * @param {string} str2 - The second string to compare.
 * @returns {number} A similarity score between 0 (completely different) and 1 (exact match).
 */
